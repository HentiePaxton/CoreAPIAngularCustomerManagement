...
namespace CompanyAPI.Controllers
{
    ...
    {
        public StatusController(CompanyDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostStatus([FromBody] Status status)
        {
            ...
            return CreatedAtAction("GetStatus", new { id = status.PkStatusId }, status);
        }
        ...
        {
            return _context.Status.Any(e => e.PkStatusId == id);
        }
    }
}